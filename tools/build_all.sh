#!/usr/bin/env bash
# ACLaniakea ColorOS Pad Port Fixes - 4.1.0 全量构建
# 输出统一到 releases/。
#
...
cp releases/PenHidCtl-v4.1.0.apk pen-bridge/module/system/priv-app/aclpenhid/PenHidCtl.apk

echo "== 5/8 root module zips =="
python3 fix-module/tools/build_fix.py
python3 pen-bridge/module/tools/build_root.py pen-bridge/module releases/PenBridge-Module-v4.1.0.zip
...
cp zui-camera-compat-hook/releases/ZUI-Camera-Compat-v4.1.0.apk releases/
