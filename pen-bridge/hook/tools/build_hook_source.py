#!/usr/bin/env python3
"""Build the pen-bridge LSPosed Hook APK from Java source (ACLaniakea 1.1.25).
...
OUT_APK = OUT_DIR / "PenBridge-Hook-v1.1.25.apk"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="penhook-src-") as td:
        ...
        run([AAPT2, "link", "-o", tmp / "base.apk", "-I", ANDROID_JAR,
             ...
             "--version-code", "1125", "--version-name", "1.1.25"])
