#!/usr/bin/env python3
"""Build the PenTouchpadGuard LSPosed APK (com.aclaniakea.pentouchpadguard)."""
...
ALIAS = "aclaniakea"
OUT_APK = ROOT.parents[0] / "releases" / "PenTouchpadGuard-v1.0.1.apk"
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="penguard-") as td:
        tmp = Path(td)
