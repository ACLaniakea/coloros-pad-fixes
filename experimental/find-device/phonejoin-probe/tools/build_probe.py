#!/usr/bin/env python3
"""Build the PhoneJoinProbe LSPosed APK (com.aclaniakea.phonejoinprobe)."""
...
ALIAS = "aclaniakea"
OUT_APK = ROOT.parents[0] / "releases" / "PhoneJoinProbe-v1.1.0.apk"
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="probe-") as td:
        tmp = Path(td)
